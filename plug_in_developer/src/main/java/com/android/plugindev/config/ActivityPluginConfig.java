package com.android.plugindev.config;
 ...
 */
public class ActivityPluginConfig {
    /**
     * 插件所属apk
     */
    ApkInfo from;
    ...
    /**
     * 设置处于顶部的插件Activity名
     * @param topActivityName 处于顶部的插件Activity名
     */
    ...
    public ActivityPluginConfig(Activity proxyParent, String apkPath) {
        this.proxyParent = proxyParent;
